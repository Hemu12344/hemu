  ...
  return(
    ...
    {clientData.length > 0 && (
        ...
        <button
          ...
          className="absolute left-5 top-1/2 -translate-y-1/2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-100 p-3 rounded-full shadow-md transition"
        >
          &#8249;
        </button>
        ...
        <button
          onClick={() => handleChange(1)}
          className="absolute right-5 top-1/2 -translate-y-1/2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-100 p-3 rounded-full shadow-md transition"
        >
          &#8250;
        </button>
    </>
